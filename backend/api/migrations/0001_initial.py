# Generated by Django 4.0.6 on 2023-03-25 17:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('difficulty', models.PositiveSmallIntegerField(choices=[(0, 'Easy'), (1, 'Moderate'), (2, 'Complex'), (3, 'Unknown')], default=3)),
                ('categories', models.ManyToManyField(to='api.category')),
            ],
            options={
                'db_table': 'words',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('english_level', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Intermediate'), (1, 'Upper Intermediate'), (2, 'Advanced')], null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='api.supercategory'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voice_url', models.TextField()),
                ('sentence_text', models.CharField(blank=True, max_length=20, null=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.question')),
            ],
            options={
                'db_table': 'examples',
